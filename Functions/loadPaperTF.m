function HF = loadPaperTF(TH,M,NA,dim,WVL,theta,LD)
% Paloma Casteleiro Costa - April 2019
% Algorithm developed by Patrick Ledwig and Paloma Casteleiro Costa
gamma = -2;
...
for col = 1:2
    ...
    S = paperDiffuse(dim,LD,3,theta*pi/180);
    S(isnan(S)) = 0;
